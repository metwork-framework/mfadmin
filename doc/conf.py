...
latex_documents = [
    (master_doc, 'mfadmin.tex',
     u'mfadmin Documentation',
     u'MetWork', 'manual'),
]
...
man_pages = [
    (master_doc, 'mfadmin', u'mfadmin Documentation',
     [author], 1)
]
...
intersphinx_mapping = {'mfext': (build_intersphinx_mapping_url(project, 'mfext'), None),
                       ...
                       'mfserv': (build_intersphinx_mapping_url(project, 'mfserv'), None),
                       'mfcom': (build_intersphinx_mapping_url(project, 'mfcom'), None),
                       }
...
texinfo_documents = [
    (master_doc, 'mfadmin', u'mfadmin Documentation',
     author, 'mfadmin', 'One line description of project.',
     'Miscellaneous'),
]
