...
MFADMIN_VERSION=$("${MFEXT_HOME}/bin/guess_version.sh")
export MFADMIN_VERSION
...
export MODULE=MFADMIN
export MODULE_LOWERCASE=mfadmin
...
echo "export MODULE_VERSION := ${MFADMIN_VERSION}" >>adm/root.mk
...
echo "export ${MODULE}_VERSION := ${MFADMIN_VERSION}" >>adm/root.mk
