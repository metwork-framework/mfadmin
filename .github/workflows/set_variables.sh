...
echo "buildlog_dir=/pub/metwork/${CI}/buildlogs/${B}/mfadmin/${OS_VERSION}/${GITHUB_RUN_NUMBER}" >> ${GITHUB_OUTPUT}
echo "skip_dispatch=${SKIP_DISPATCH}" >> ${GITHUB_OUTPUT}

echo "rpm_dir=/pub/metwork/${CI}/rpms/${B}/${OS_VERSION}" >> ${GITHUB_OUTPUT}
echo "doc_dir=/pub/metwork/${CI}/docs/${B}/mfadmin" >> ${GITHUB_OUTPUT}
