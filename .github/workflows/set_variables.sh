...
echo "::set-output name=buildlog_dir::/pub/metwork/${CI}/buildlogs/${B}/mfadmin/${OS_VERSION}/${GITHUB_RUN_NUMBER}"
echo "::set-output name=skip_dispatch::${SKIP_DISPATCH}"

echo "::set-output name=rpm_dir::/pub/metwork/${CI}/rpms/${B}/${OS_VERSION}"
echo "::set-output name=doc_dir::/pub/metwork/${CI}/docs/${B}/mfadmin"
